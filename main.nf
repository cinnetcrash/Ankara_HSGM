...
params.iqtree2_options                      = '-ninit 2 -n 2 -me 0.09 -m GTR'
params.ivar_consensus_options               = '-q 10 -t 0.9 -n N'
params.ivar_trim_options                    = ''
params.ivar_variants_options                = '-q 10 -t 0.9'
...
params.seqyclean_options                    = '-minlen 10 -qual'
